...
export default function HowItWorkSection() {
    ...
    transform-gpu overflow-hidden blur-3xl">
        ...
        w-[36.125rem] -translate-x-1/2 bg-linear-to-br from-emerald-500 via-teal-500 to-cyan-500 
...
function StepItem({ icon, label, description }: Step) {
    return (
        <div className='relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border border-white/10 hover:border-rose-500/50
