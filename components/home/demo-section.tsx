    ...
    return (
        ...
        lg:px-8 lg:pt-12">
            ...
            transform-gpu overflow-hidden blur-3xl"
                ...
                from-emerald-500 via-teal-500 to-cyan-500 opacity-30s
            ...
            space-y-4">
                ...
                p-2 rounded-2xl bg-gray-100/80 backdrop-blur-xs border border-gray-500/20 mb-4">
                        <Pizza className="w-6 h-6 text-rose-500" />
                    </div>
                    <div className="text-center mb-16">
                        <h3 className="font-bold text-3xl max-w-2xl mx-auto px-4
               sm:px-6">
