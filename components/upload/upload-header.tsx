    ...
    return (
         <div className="flex flex-col items-center justify-center gap-6 text-center">
                    ...
                    <Badge variant={'secondary'}
                     className=" relative px-6 py-2 text-base text-rose-600 font-medium bg-white rounded-full group-hover:bg-gray-50 transition-colors">
                        <Sparkles className="h-6 w-6 mr-2 text-rose-600 animated-pulse"/>
                        <p className="text-base">AI-Powered Content Creation</p>
                    </Badge>
                     </MotionDiv>
                     <MotionDiv 
                     variants={itemVariants}
                     className="capitalize text-3xl font-bold tracking-tight text-gray-900
                     sm:text-4xl">
                     Start Uploading {' '}
