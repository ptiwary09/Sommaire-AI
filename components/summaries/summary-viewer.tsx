...
const SectionTitle = ({ title }: { title: string }) => {
  return (
    <div className="flex flex-col gap-2 mb-6 sticky top-0 pt-2 pb-4 bg-background/80 backdrop-blur-sm z-10">
...
export function SummaryViewer({ summary }: { summary: string }) {
  ...
  return (
    <Card className="relative h-[500px] sm:h-[600px] lg:h-[700px] w-full xl:w-[600px] overflow-hidden bg-white backdrop-blur-lg shadow-2xl rounded-3xl border border-gray-200/50">
