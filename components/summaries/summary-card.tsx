...
export default function SummaryCard({ summary }: { summary: any }) {
  // Add this debug logging to see what's in your summary object
  console.log("SummaryCard - Full summary object:", summary);
  console.log("SummaryCard - summary.id:", summary.id);
  ...
  return (
    <Card className="relative border border-gray-200 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 p-4 sm:p-6">
      ...
      <div className="absolute top-2 right-2">
        <DeleteButton summaryId={summary.id || summary.summary_id || summary.uuid} />
      </div>
