   ...
   return (
    <div className = "relative min-h-[50vh]">
        ...
        <div className="flex flex-col items-center justify-center gap-8 text-center max-w-2xl mx-auto">
            ...
            <p className="text-lg leading-8 text-gray-600 border-2 border-rose-200 bg-white/50 backdrop-blur-xs rounded-lg p-6 border-dashed max-w-xl">You need to upgrade the Basic Plan or the Pro Plan to access this feature💖</p>
         <Button 
         asChild 
